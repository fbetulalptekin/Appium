...
public class DenemeTesti {
    ...
    AndroidDriver<AndroidElement> driver;  // android cihazların driver'ı

    // AppiumDriver<MobileElement> appiumDriver; // hem android'de hem de ios'ta çalışır
    ...
    public void deneme01() throws MalformedURLException {
     ...
     // capabilities.setCapability(MobileCapabilityType.APP,"C:\\Users\\fbalp\\IdeaProjects\\Appium\\Apps\\Calculator_8.4 (503542421)_Apkpure.apk");
